...
*MeDriveApi* | [**unfollowDriveItem**](docs/Api/MeDriveApi.md#unfollowdriveitem) | **DELETE** /v1.0/me/drive/following/{item-id} | Unfollow a DriveItem
...
*UserTeamworkApi* | [**sendActivityNotification**](docs/Api/UserTeamworkApi.md#sendactivitynotification) | **POST** /v1.0/users/{user-id}/teamwork/sendActivityNotification | Send an activity notification to a user
...
- [ActivityNotification](docs/Model/ActivityNotification.md)
...
- [PendingOperations](docs/Model/PendingOperations.md)
- [PendingOperationsPendingContentUpdate](docs/Model/PendingOperationsPendingContentUpdate.md)
