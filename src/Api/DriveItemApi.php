...
class DriveItemApi
{
    ...
    {
        list($response) = $this->getDriveItemWithHttpInfo($drive_id, $item_id, $select, $expand, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getDriveItemRequest($drive_id, $item_id, $select, $expand, $contentType);
    ...
    {
        return $this->getDriveItemAsyncWithHttpInfo($drive_id, $item_id, $select, $expand, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDriveItemContent
     *
     * Download the content of a DriveItem
     *
     * @param  string $drive_id key: id of drive (required)
     * @param  string $item_id key: id of item (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDriveItemContent'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return |\OpenAPI\Client\Model\OdataError|\OpenAPI\Client\Model\OdataError
     */
    public function getDriveItemContent(
        string $drive_id,
        string $item_id,
        string $contentType = self::contentTypes['getDriveItemContent'][0]
    )
    {
        list($response) = $this->getDriveItemContentWithHttpInfo($drive_id, $item_id, $contentType);
        return $response;
    }

    /**
     * Operation getDriveItemContentWithHttpInfo
     *
     * Download the content of a DriveItem
     *
     * @param  string $drive_id key: id of drive (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of |\OpenAPI\Client\Model\OdataError|\OpenAPI\Client\Model\OdataError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDriveItemContentWithHttpInfo(
        string $drive_id,
        string $item_id,
        string $contentType = self::contentTypes['getDriveItemContent'][0]
    ): array
    {
        $request = $this->getDriveItemContentRequest($drive_id, $item_id, $contentType);
        ...
        try {
            ...
            $returnType = '\OpenAPI\Client\Model\OdataError';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation getDriveItemContentAsync
     *
     * Download the content of a DriveItem
     *
     * @param  string $drive_id key: id of drive (required)
     ...
     * @return PromiseInterface
     */
    public function getDriveItemContentAsync(
        string $drive_id,
        string $item_id,
        string $contentType = self::contentTypes['getDriveItemContent'][0]
    ): PromiseInterface
    {
        return $this->getDriveItemContentAsyncWithHttpInfo($drive_id, $item_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDriveItemContentAsyncWithHttpInfo
     *
     * Download the content of a DriveItem
     *
     * @param  string $drive_id key: id of drive (required)
     ...
     * @return PromiseInterface
     */
    public function getDriveItemContentAsyncWithHttpInfo(
        $drive_id,
        $item_id,
        string $contentType = self::contentTypes['getDriveItemContent'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'getDriveItemContent'
     *
     * @param  string $drive_id key: id of drive (required)
     * @param  string $item_id key: id of item (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDriveItemContent'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDriveItemContentRequest(
        $drive_id,
        $item_id,
        string $contentType = self::contentTypes['getDriveItemContent'][0]
    ): Request
    {
        ...
        if ($drive_id === null || (is_array($drive_id) && count($drive_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $drive_id when calling getDriveItemContent'
            );
        }
        ...
        if ($item_id === null || (is_array($item_id) && count($item_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $item_id when calling getDriveItemContent'
            );
        }


        $resourcePath = '/v1beta1/drives/{drive-id}/items/{item-id}/content';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string[]|null $select Select additional properties to be returned. (optional)
     * @param  string[]|null $expand Expand related entities to be returned. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDriveItemV1'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \OpenAPI\Client\Model\DriveItem|\OpenAPI\Client\Model\OdataError
     */
    public function getDriveItemV1(
        string $drive_id,
        string $item_id,
        ??array $select = null,
        ??array $expand = null,
        string $contentType = self::contentTypes['getDriveItemV1'][0]
    )
    {
        list($response) = $this->getDriveItemV1WithHttpInfo($drive_id, $item_id, $select, $expand, $contentType);
        return $response;
    }

    /**
     * Operation getDriveItemV1WithHttpInfo
     *
     * Get a DriveItem.
     *
     * @param  string $drive_id key: id of drive (required)
     ...
     * @return array of \OpenAPI\Client\Model\DriveItem|\OpenAPI\Client\Model\OdataError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDriveItemV1WithHttpInfo(
        string $drive_id,
        string $item_id,
        ??array $select = null,
        ??array $expand = null,
    ...
    {
        $request = $this->getDriveItemV1Request($drive_id, $item_id, $select, $expand, $contentType);
     ...
     * @return PromiseInterface
     */
    public function getDriveItemV1Async(
        string $drive_id,
        string $item_id,
        ??array $select = null,
        ??array $expand = null,
    ...
    {
        return $this->getDriveItemV1AsyncWithHttpInfo($drive_id, $item_id, $select, $expand, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDriveItemV1AsyncWithHttpInfo
     *
     * Get a DriveItem.
     *
     * @param  string $drive_id key: id of drive (required)
     ...
     * @return PromiseInterface
     */
    public function getDriveItemV1AsyncWithHttpInfo(
        $drive_id,
        $item_id,
        $select = null,
        $expand = null,
    ...
    /**
     * Create request for operation 'getDriveItemV1'
     *
     * @param  string $drive_id key: id of drive (required)
     * @param  string $item_id key: id of item (required)
     * @param  string[]|null $select Select additional properties to be returned. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDriveItemV1Request(
        $drive_id,
        $item_id,
        $select = null,
        $expand = null,
    ...
    ): Request
    {
        ...
        if ($drive_id === null || (is_array($drive_id) && count($drive_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $drive_id when calling getDriveItemV1'
            );
        }
        ...
        if ($item_id === null || (is_array($item_id) && count($item_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $item_id when calling getDriveItemV1'
            );
        }
        ...
        $resourcePath = '/v1.0/drives/{drive-id}/items/{item-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
